...
| 2026-06-29 | #53. Maximum Subarray | Dynamic Programming (Kadane's) | Passed | rung 0 | 重置條件應為 current+num < num（等價 current < 0）；elif 分支為 dead code；DP 本質：dp[i] = max(num, dp[i-1]+num) |
